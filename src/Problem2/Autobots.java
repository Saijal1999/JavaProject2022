...
public class Autobots extends TheTransformationCompany{


    public Autobots(String Name, String FirstCharacter, int strength, int intelligence, int speed, int Endurance, int Rank, int courage, int Firepower, int skill) {
